...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="static/css/bootstrapValidator.css">
    <style type="text/css">
        body {
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <div class="list-group">
                    <a href="${pageContext.request.contextPath}/category?method=queryCategoryList&currentCount=0&currentPage=0" class="list-group-item text-center ">生鲜列表</a>
                    <a href="${pageContext.request.contextPath}/category-list.jsp"
            ...
            <div class="col-md-9">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form action="category" method="post" class="form-horizontal" role="form" id="form-test">
                            <div class="form-group">
                                <input type="hidden" name="method" value="addCategory">
                                <label class="col-sm-2 control-label">名称</label>
                                <div class="col-sm-5">
                                    <input type="text" name="c_name" class="form-control" placeholder="生鲜名称" required data-bv-notempty-message="名称不能为空">
                                </div>
                                <div class="col-sm-5">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <input type="text" name="place" class="form-control" placeholder="产地" required data-bv-notempty-message="产地不能为空">
                                </div>
                                <div class="col-sm-5">
