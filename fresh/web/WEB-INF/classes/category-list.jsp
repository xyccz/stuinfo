    ...
    <div class="row">
      ...
      <div class="col-md-3">
        <div class="list-group">
          <a href="${pageContext.request.contextPath}/category?method=queryCategoryList&currentCount=0&currentPage=0" class="list-group-item text-center active">生鲜列表</a>
            ...
            <table class="table table-striped table-responsive table-hover">
              ...
              <c:forEach items="${page.list}" var="category">
                <tr>
                  ...
                  <td>
                      <%--<a href="">详情</a>--%>
                    <a href="${pageContext.request.contextPath}/category?method=deleteCategory&c_id=${category.c_id}" onclick="return confirm('是否确认删除？');">删除</a>
                    <a href="javascript:location.href=encodeURI('${pageContext.request.contextPath}/category-update.jsp?c_id=${category.c_id}&c_name=${category.c_name}&type=${category.type}&place=${category.place}')">修改</a>
                  </td>
                </tr>
              </c:forEach>
        ...
        <nav>
          <ul class="pagination pull-right">
            ...
            <c:forEach begin="1" end="${page.totalPage}" var="Page">
              <li><a href="${pageContext.request.contextPath}/category?method=queryCategoryList&currentPage=${Page}&currentCount=5">${Page}</a></li>
            </c:forEach>
            <li><a href="#">&raquo;</a></li>
          </ul>
