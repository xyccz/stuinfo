          ...
          <div class="panel-body">
            <form action="category" method="post" class="form-horizontal" role="form">
              <div class="form-group">
                ...
                <div class="col-sm-5">
                  <input type="text" name="c_name" value="${param.c_name}" class="form-control" placeholder="生鲜名称" required data-bv-notempty-message="名称不能为空">
                </div>
                <div class="col-sm-5">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-5">
                  <input type="text" name="place"  value="${param.place}" class="form-control" placeholder="产地" required data-bv-notempty-message="名称不能为空">
                </div>
