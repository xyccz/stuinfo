...
--%>
<%@ page contentType="text/html;charset=UTF-8" language="java"  import="sun.security.util.Password"%>
                ...
                <div class="login_form">
                    <form action="user"
                        ...
                        <div style="margin-left: 45px;margin-top: 10px">
                            <input style="vertical-align: middle;" type="checkbox" value="yes" name="remember" checked="checked">记住密码<br/>
